      ...
      {askForUsername === true ? (
        <div>
          <div className={styles.connections}>
            <h2 style={{ paddingBottom: "1rem" }}>Enter into Lobby</h2>
            <TextField
              id="outlined-basic"
              label="Username"
              value={username}
            ...
            />
            <Button
              style={{ height: "3.4rem", marginLeft: "1rem" }}
              variant="contained"
              onClick={connect}
            >
              Connect
        ...
        <div className={styles.meetingVideoContainer}>
          {showModal && (
            <div className={styles.chatRoom}>
              <div className={styles.chatContainer}>
                ...
                <div className={styles.chattingArea}>
                  ...
                  />
                  <Button
                    style={{ height: "3.4rem", marginLeft: "0.5rem" }}
                    variant="contained"
                    onClick={sendMessage}
                  >
                    Send
